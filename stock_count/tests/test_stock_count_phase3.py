        ...
        cls.counter = cls.env["res.users"].create(
            {
                ...
                "group_ids": [(6, 0, [base_user.id, cls.counter_group.id, export_group.id])],
            }
        )
        cls.other_counter = cls.env["res.users"].create(
            {
                ...
                "group_ids": [(6, 0, [base_user.id, cls.counter_group.id])],
            }
        )
        cls.supervisor = cls.env["res.users"].create(
            {
                ...
                "group_ids": [(6, 0, [base_user.id, cls.manager_group.id, export_group.id])],
            }
        )
